  ...
  return (
    <footer className={`${styles.footer} ${theme === 'dark' ? styles.darkMode : styles.lightMode}`}>
      <Box className={styles.themeToggle}>
        ...
        />
        {/* Visual indicator for the sliding effect */}
        <Box
          className={`${styles.slider} ${theme === 'dark' ? styles.darkMode : styles.lightMode}`}
          style={{ left: theme === 'dark' ? '30px' : '0px' }} // Adjust left position for the slider
        />
      </Box>
    </footer>
  );
