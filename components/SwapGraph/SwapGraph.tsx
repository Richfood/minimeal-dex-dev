...
interface SwapGraphState {
    series: ChartData[];
    options: ApexCharts.ApexOptions;
    activeInterval: '24Hours' | '1Week' | '1Month' | '1Year';
}

class SwapGraph extends Component<{}, SwapGraphState> {
    constructor(props: {}) {
        super(props);
    ...
    componentDidMount() {
        this.fetchNewData('24Hours');
    }

    fetchNewData = (interval: '24Hours' | '1Week' | '1Month' | '1Year') => {
    ...
    render() {
        const { options, series, activeInterval } = this.state;
...
export default dynamic(() => Promise.resolve(SwapGraph), { ssr: false });