...
>
    <Typography sx={{ color: theme === 'light' ? 'var(--cream)' : 'var(--white)' }}>Min: <Typography sx={{ color: theme === 'light' ? 'var(--primary)' : 'var(--cream)' }} component="span">{parseFloat(tickToPrice(upperTick, decimalDifference).toFixed(3))} {data.token0.symbol} per {data.token1.symbol}</Typography></Typography>
    <Typography><VscArrowBoth /></Typography>
    <Typography sx={{ color: theme === 'light' ? 'var(--cream)' : 'var(--white)' }}>Max: <Typography sx={{ color: theme === 'light' ? 'var(--primary)' : 'var(--cream)' }} component="span">{parseFloat(tickToPrice(lowerTick, decimalDifference).toFixed(3))} {data.token0.symbol} per {data.token1.symbol}</Typography></Typography>
</Box>
</Box>
    )
